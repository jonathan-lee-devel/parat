...
def start_build(verbose: bool, job_name: str) -> None:
    ...
    response_status_code = start_jenkins_build(JenkinsRequestSettings(os.getenv('JENKINS_URL'), (os.getenv('JENKINS_USER'), os.getenv('JENKINS_TOKEN')), 1), job_name).status_code
...
def get_console_output(verbose: bool, job_name: str, build_number: int) -> None:
    ...
    console_output = get_jenkins_console_output(JenkinsRequestSettings(os.getenv('JENKINS_URL'), (os.getenv('JENKINS_USER'), os.getenv('JENKINS_TOKEN')), 1), job_name, build_number)
...
def get_jenkins_json(verbose: bool, job_name: str, build_number: int) -> None:
    ...
    jenkins_dict = get_jenkins_job_dict(JenkinsRequestSettings(os.getenv('JENKINS_URL'), (os.getenv('JENKINS_USER'), os.getenv('JENKINS_TOKEN')), 1), job_name, build_number)
